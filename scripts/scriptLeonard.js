...
let answers = [
    ["Aaaah oui la Cène. C'est une peinture murale que j’ai réalisée de 1495 à 1498 pour le réfectoire du couvent Dominicain de Santa Maria delle Grazie à Milan.", "J'ai peint la Cène pour le réfectoire du couvent dominicain de Santa Maria delle Grazie à Milan. C'est une peinture murale que j'ai réalisée en seulement 3 ans !", "La Cène est l'une de mes plus belles œuvres, sans nul doute ! Je la réalisai entre 1495 et 1498 pour le réfectoire du couvent dominicain de Santa Maria delle Grazie à Milan !"],
    ...
    ["Je suis particulièrement fier de mes œuvres 'La Joconde' et 'la Cène'", "Je ne sais pas si je peux les qualifier d'inventions, mais mes œuvres les plus réputées sont sans aucun doute La Joconde et la Cène", "La Cène et La Joconde, ces peintures sont sublimes ! Vous ne trouvez pas ?"],
    ["La Joconde, ou Portrait de Mona Lisa, est un tableau que j’ai réalisé entre 1503 et 1506 ou entre 1513 et 1516, je ne me souviens plus vraiment.", "J'ai peint La Joconde en 3 ans, ce tableau est à l'heure actuelle, considéré comme l'une de mes plus belles œuvres !", "Ah, La Joconde... Ce tableau représente 3 dures années de travail, mais ça en valait la peine !"],
    ["J’ai commencé à m’initier à l'anatomie du corps humain lors de mon apprentissage avec Andrea del Verrocchio, mon maître. Comme artiste, je suis rapidement devenu un expert de l’anatomie topographique, notamment après mes nombreuses études des muscles, des tendons et d'autres caractéristiques anatomiques visibles."],
    ...
    ["La Joconde se trouve actuellement au Louvre.", "La Joconde est exposée au Louvre.", "Tu peux la retrouver au Louvre.", "Je crois bien qu'elle se trouve au Louvre maintenant."],
    ["La Cène est exposée à l’Église Santa Maria delle Grazie de Milan.", "La Cène est exposé à l’Église Santa Maria delle Grazie de Milan.", "Tu peux la retrouver à l’Église Santa Maria delle Grazie de Milan.", "Je crois bien qu'elle se trouve à l’Église Santa Maria delle Grazie de Milan."],
    ["Je repose à la Chapelle Saint-Hubert à Amboise.", "Je suis enterré à la Chapelle Saint-Hubert à Amboise.", "Ma tombe se situe à Amboise, au seins de la Chapelle Saint-Hubert.", "Tu pourras peut-être me voir à la Chapelle Saint-Hubert à Amboise, c'est là que je repose !"],
    ["Oui, mais bien que cela soit mal vu, cela m’a permis d’étudier en profondeur l’anatomie du corps humain afin d’en comprendre les mécanismes.", "En effet j'ai utilisé certains cadavres afin d'approfondir mes recherches sur l'anatomie humaine."],
