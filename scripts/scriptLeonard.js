...
let videoPath = [
    ...
    [
        ...
        require("../assets/videos/leonard_de_vinci/qui-est-mona-lisa-v2.mov")
    ],
    [
        require("../assets/videos/leonard_de_vinci/oeuvres-plus-de-succes.mov"),
        require("../assets/videos/leonard_de_vinci/tes-plus-belles-oeuvres-v2.mov"),
        require("../assets/videos/leonard_de_vinci/tes-plus-belles-oeuvres-v3.mov")
    ],
    [
        require("../assets/videos/leonard_de_vinci/presentation-joconde.mov"),
        require("../assets/videos/leonard_de_vinci/parle-moi-de-la-jocondev2.mov"),
        require("../assets/videos/leonard_de_vinci/parle-moi-de-la-joconde-v3.mov")

    ],
    [
        require("../assets/videos/leonard_de_vinci/presentation-la-cene.mov"),
        require("../assets/videos/leonard_de_vinci/parle-moi-de-la-cene-v2.mov"),
        require("../assets/videos/leonard_de_vinci/parle-moi-de-la-cene-v3.mov")
    ],
    [
    ...
    [
        ...
        require("../assets/videos/leonard_de_vinci/ou-se-trouve-joconde-v2.mov"),
        require("../assets/videos/leonard_de_vinci/ou-se-trouve-joconde-v3.mov")
    ],
    [
        require("../assets/videos/leonard_de_vinci/lieu-expo-cene.mov"),
        require("../assets/videos/leonard_de_vinci/ou-se-trouve-cene-v2.mov"),
        require("../assets/videos/leonard_de_vinci/ou-se-trouve-cene-v3.mov")
    ],
    [
        require("../assets/videos/leonard_de_vinci/lieu-enterrement.mov"),
        require("../assets/videos/leonard_de_vinci/ou-est-tu-enterre-v2.mov"),
        require("../assets/videos/leonard_de_vinci/ou-est-tu-enterre-v3.mov")
    ],
    [
        require("../assets/videos/leonard_de_vinci/question-dissection.mov"),
        require("../assets/videos/leonard_de_vinci/as-tu-dissequé-v2.mov")
    ],
    [
